    ...
    <div class="grid_template">
        <div class="header">
            ...
            <div class="header__btn">
                <button class="header__red">Перевод из frx</button>
                <button>Работа с документами</button>
                <button>Приколдесы</button>
            </div>
            <p class="header__red">Выйти</p>
        </div>
        <div class="body grid__file">
            ...
            <h2>История</h2>
            <div class="last__caption">
                <div>Ваши файлы</div>
                <div>Формат файла</div>
                <div>Дата конвертации</div>
            </div>
...
.last__item, .last__caption {
    display: grid;
    grid-template-columns: 40% auto auto 20%;
    gap: 30px;
    text-align: center;
}
.last__item div:first-child, .last__caption div:first-child {
...
.file__convert select {
    background: none;
    padding: 5px 15px;
    border-radius: 6px;
}
.file__convert button {
    background-color: #DD4434;
    color: black;
    font-weight: bold;
    border-radius: 6px;
